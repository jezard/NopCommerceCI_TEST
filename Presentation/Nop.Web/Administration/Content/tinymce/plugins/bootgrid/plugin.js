tinymce.PluginManager.add('bootgrid', function (editor, url) {
    ...
    */
    ...
    editor.addMenuItem('bootgrid-3-3-3-3', {
        ...
        onclick: function () {
            var html = '<div class="row">' +
                '<div class="col-sm-3 col-md-3"><div>Col 1</div><div>&nbsp;</div></div>' +
                '<div class="col-sm-3 col-md-3"><div>Col 2</div><div>&nbsp;</div></div>' +
                '<div class="col-sm-3 col-md-3"><div>Col 3</div><div>&nbsp;</div></div>' +
                '<div class="col-sm-3 col-md-3"><div>Col 4</div><div>&nbsp;</div></div>' +
    ...
    editor.addMenuItem('bootgrid-8-4', {
        ...
        onclick: function () {
            var html = '<div class="row">' +
                '<div class="col-sm-8 col-md-8"><div>Col 1</div><div>&nbsp;</div></div>' +
                '<div class="col-sm-4 col-md-4"><div>Col 2</div><div>&nbsp;</div></div>' +
                '</div><p class="editor-row-spacer" style="display:none">&nbsp;</p>';
            editor.insertContent(html);
        }
    });
    ...
    editor.addMenuItem('bootgrid-4-8', {
        ...
        onclick: function () {
            var html = '<div class="row">' +
                '<div class="col-sm-4 col-md-4"><div>Col 1</div><div>&nbsp;</div></div>' +
                '<div class="col-sm-8 col-md-8"><div>Col 2</div><div>&nbsp;</div></div>' +
                '</div><p class="editor-row-spacer" style="display:none">&nbsp;</p>';
            editor.insertContent(html);
        }
    });
    ...
    editor.addMenuItem('bootgrid-6-6', {
        ...
        onclick: function () {
            var html = '<div class="row">' +
                '<div class="col-sm-6 col-md-6"><div>Col 1</div><div>&nbsp;</div></div>' +
                '<div class="col-sm-6 col-md-6"><div>Col 2</div><div>&nbsp;</div></div>' +
                '</div><p class="editor-row-spacer" style="display:none">&nbsp;</p>';
            editor.insertContent(html);
        }
    });
    ...
    editor.addMenuItem('bootgrid-3-9', {
        ...
        onclick: function () {
            var html = '<div class="row">' +
                '<div class="col-sm-3 col-md-3"><div>Col 1</div><div>&nbsp;</div></div>' +
                '<div class="col-sm-9 col-md-9"><div>Col 2</div><div>&nbsp;</div></div>' +
                '</div><p class="editor-row-spacer" style="display:none">&nbsp;</p>';
            editor.insertContent(html);
        }
    });
    ...
    editor.addMenuItem('bootgrid-9-3', {
        ...
        onclick: function () {
            var html = '<div class="row">' +
                '<div class="col-sm-9 col-md-9"><div>Col 1</div><div>&nbsp;</div></div>' +
                '<div class="col-sm-3 col-md-3"><div>Col 2</div><div>&nbsp;</div></div>' +
                '</div><p class="editor-row-spacer" style="display:none">&nbsp;</p>';
            editor.insertContent(html);
        }
    ...
    editor.addMenuItem('bootgrid-4-4-4', {
        ...
        onclick: function () {
            var html = '<div class="row">' +
                '<div class="col-sm-4 col-md-4"><div>Col 1</div><div>&nbsp;</div></div>' +
                '<div class="col-sm-4 col-md-4"><div>Col 2</div><div>&nbsp;</div></div>' +
                '<div class="col-sm-4 col-md-4"><div>Col 3</div><div>&nbsp;</div></div>' +
                '</div><p class="editor-row-spacer" style="display:none">&nbsp;</p>';
            editor.insertContent(html);
        }
    });
    ...
    editor.addMenuItem('bootgrid-12', {
        ...
        onclick: function () {
            var html = '<div class="row">' +
                '<div class="col-sm-12 col-md-12"><div>Col 1</div><div>&nbsp;</div></div>' +
                '</div><p class="editor-row-spacer" style="display:none">&nbsp;</p>';
            editor.insertContent(html);
        }
    });
